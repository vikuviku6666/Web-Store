    ...
    createProductCard = (product) => {
        try {
            axios.all([
                ...
                axios.get(`https://webstoretostockholm.azurewebsites.net/api/ProductCategorys`)
            ])
                .then(axios.spread((obj1, obj2, obj5) => {
                    let obj3 = (obj1.data).concat(obj2.data, obj5.data);
                   
                    let obj4 = [{ ...obj3[0], ...obj3[7] }, { ...obj3[1], ...obj3[8]  }, { ...obj3[2], ...obj3[9] }, { ...obj3[3], ...obj3[10] },
                    { ...obj3[4], ...obj3[11] }, { ...obj3[5], ...obj3[12] }, { ...obj3[6], ...obj3[13] }];
                    console.log("createProductCard -> obj4", obj4)
